      ...
      >
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
            🌟 Welcome to my profile! I am thrilled to share my journey with
            you. 🚀
          ...
          <p className="mb-8 leading-relaxed">
            ...
            new challenges. That is why I embarked on an exciting transition
            into the world of technology. 🌐 👨‍💻 My tech journey began with
            Henry, an immersive coding bootcamp. During this transformative
            experience, I immersed myself in the realm of web development and
            emerged with the coveted title of Full Stack Developer. My primary
            focus and passion lie in the back end, where I relish building
            robust, efficient systems that power web applications. 💡
            Philosophy: I strongly believe that the skills and mindset
            cultivated in my previous career are invaluable in the tech world.
            My ability to strategize, adapt, and lead teams brings a unique
            perspective to problem-solving in the ever-evolving tech landscape.
          ...
          <div className="flex justify-center">
            ...
            >
              📫 I am excited about the limitless possibilities that technology
              offers and eager to contribute my unique skills to innovative
              projects. If you would like to collaborate or learn more about my
